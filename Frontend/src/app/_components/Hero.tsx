    ...
    return (
        <div>
            ...
            <div className="mt-4 flex flex-wrap gap-3 items-center">
                <button onClick={onOpenChat} className="inline-flex items-center gap-3 px-5 py-3 rounded-full bg-gradient-to-br from-cyan-500 to-teal-500 text-slate-900 font-semibold shadow-lg">Try the chat</button>
