            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="p-6 bg-gradient-to-br from-cyan-600/10 to-teal-500/6 border border-slate-700 rounded-xl">
                 ...
                 <div className="mt-4 flex flex-col gap-3">
                  <button onClick={onOpenChat} className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-cyan-500 text-slate-900 font-semibold">Try chat</button>
