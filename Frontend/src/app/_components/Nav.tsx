  ...
  return (
    <nav className="w-full max-w-[1400px] mx-auto px-6 py-5 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-6 text-sm">
        ...
        <a href="#pricing" className="hover:text-white/90">
          Plans
        </a>
      ...
      <div className="md:hidden">
        <button
          onClick={onOpenChat}
          className="inline-flex items-center px-3 py-1.5 rounded-full bg-cyan-500 text-slate-900 text-sm font-medium"
        >
          Chat
        </button>
      </div>
