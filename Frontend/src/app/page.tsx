        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 py-12 w-full items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-300 max-w-2xl text-lg">
              Bridge technical and non-technical stakeholders with automated
              data quality checks, anomaly detection, and natural-language
              conversational queries — all in one middleware layer. Real-time,
